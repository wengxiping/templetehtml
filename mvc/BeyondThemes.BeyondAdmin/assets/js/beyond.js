...
if (location.pathname != "/Home/Persian" && location.pathname != "/Home/Arabic") {
...
function InitiateSettings() {
    ...
    if (readCookie("sidebar-fixed") != null) {
        if (readCookie("sidebar-fixed") == "true") {
            ...
            var position = (readCookie("rtl-support") || location.pathname == "/Home/Persian" || location.pathname == "/Home/Arabic") ? 'right' : 'left';
